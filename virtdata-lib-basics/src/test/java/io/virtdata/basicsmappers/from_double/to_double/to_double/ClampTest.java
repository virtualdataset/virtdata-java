package io.virtdata.basicsmappers.from_double.to_double.to_double;

import io.virtdata.basicsmappers.from_double.to_double.Clamp;
...
public class ClampTest {
    ...
    public void testIntUnaryClamp() {
        io.virtdata.basicsmappers.unary_int.Clamp clamp = new io.virtdata.basicsmappers.unary_int.Clamp(9, 13);
    ...
    public void testLongUnaryClamp() {
        io.virtdata.basicsmappers.from_long.to_long.Clamp clamp = new io.virtdata.basicsmappers.from_long.to_long.Clamp(9, 13);
