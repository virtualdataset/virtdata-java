...
public class ExprTest {
    ...
    public void testLongUnaryExpr() {
        io.virtdata.basicsmappers.from_long.to_long.Expr mod5 =
                new io.virtdata.basicsmappers.from_long.to_long.Expr("cycle % 5");
    ...
    public void testDoubleUnaryExpr() {
        io.virtdata.basicsmappers.from_double.to_double.Expr plus3point5 =
                new io.virtdata.basicsmappers.from_double.to_double.Expr("cycle + 3.5");
    ...
    public void testLongToIntExpr() {
        io.virtdata.basicsmappers.from_long.to_int.Expr minus7 =
                new io.virtdata.basicsmappers.from_long.to_int.Expr("cycle - 7");
    ...
    public void testUnaryIntExpr() {
        io.virtdata.basicsmappers.unary_int.Expr times2 =
                new io.virtdata.basicsmappers.unary_int.Expr("cycle * 2");
    ...
    public void testLongExprSpeed() {
        ...
        io.virtdata.basicsmappers.from_long.to_long.Expr mod5 =
                new io.virtdata.basicsmappers.from_long.to_long.Expr("(cycle / 10)*10 + (cycle % 5)");
        long three = mod5.applyAsLong(23);
