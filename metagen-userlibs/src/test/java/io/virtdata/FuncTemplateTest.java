...
public class FuncTemplateTest {
    ...
    public void testCombinationsTemplateValues() {
        Optional<DataMapper<String>> fto = AllDataMapperLibraries.get().getStringDataMapper("FuncTemplate('c1([[Combinations('A-Z')]])')");
    ...
    public void testStringsAndCombos() {
        Optional<DataMapper<String>> fto = AllDataMapperLibraries.get().getStringDataMapper(
